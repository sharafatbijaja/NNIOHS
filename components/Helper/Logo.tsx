...
const Logo = () => {
  return (
    <div className="flex items-center space-x-2">
      <div className="bg-blue-800 dark:bg-blue-400 w-10 h-10 rounded-full flex items-center justify-center text-white font-bold text-lg transition-all duration-200 hover:bg-blue-600 dark:hover:bg-blue-300 cursor-pointer">
