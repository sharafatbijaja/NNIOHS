            ...
            {footerSocialLinks.map((link, index) => {
              return (
                <a
                  ...
                  className="w-10 h-10 text-gray-600 dark:text-gray-400 dark:hover:text-gray-100 rounded-lg bg-white dark:bg-gray-800 shadow-md flex items-center justify-center text-shadow-muted-foreground hover:text-green-600 transition-colors duration-300"
                >
