      ...
      <div className="w-[80%] mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <p className="text-sm text-muted-foreground flex items-center gap-1 ">
             <a href="https://bijaja.com.pk" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 hover:text-white">
               Developed by {''} <Code className='w-4 h-4 text-destructive fill-destructive' /> Bijaja
             </a>
          </p>
        </div>
