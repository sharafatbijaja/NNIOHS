...
const TypingText = ({ texts, speed = 100 }: { texts: string[]; speed?: number }) => {
  ...
  return (
    <span className="inline-block">
      {displayText}
      <span className="ml-2 -mb-0.75 inline-block w-1 h-7 bg-green-500 animate-pulse" />
    </span>
  );
};
...
const Hero = () => {
  return (
    <section
      id="home"
      className="relative overflow-hidden w-full min-h-[90vh] flex items-center justify-center bg-white text-slate-900 dark:bg-slate-950 dark:text-white"
    >
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl">
        ...
        <motion.div
          ...
          className="text-xl sm:text-2xl md:text-3xl text-primary font-semibold mb-6 h-14"
        >
          <TypingText
            texts={[
