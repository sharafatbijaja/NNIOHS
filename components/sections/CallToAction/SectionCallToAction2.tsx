        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="cta-hero-bg cta-hero-glow relative overflow-hidden rounded-3xl">
            ...
            <div className="relative z-10">
              <CTA
                title="Apply Online"
                description="Let's work together to bring your vision to life. Get in touch with our team today for BSC and CNA program applications."
                buttonText="Apply BSN"
                buttonLink="/"
                variant="primary"
                size="large"
