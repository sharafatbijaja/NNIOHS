...
const AboutPage = () => {
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
      {/* Hero Section */}
      <div className="bg-linear-to-br from-blue-50 via-purple-100 to-white dark:from-gray-800 dark:via-blue-950 dark:to-gray-900 py-20">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            About <span className="text-blue-600 dark:text-blue-400">Naz Nursing Institute</span>
          </h1>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-white dark:bg-gray-900 p-8 rounded-lg shadow-lg">
              <div className="w-24 h-24 bg-blue-200 dark:bg-blue-800 rounded-full mx-auto mb-6 flex items-center justify-center">
                <span className="text-2xl font-bold text-blue-600 dark:text-blue-400">FK</span>
              </div>
