  ...
  return (
    <div className="py-20 bg-gray-100 dark:bg-gray-950">
      ...
      <div className="relative px-6 max-w-4xl mx-auto">
        {/* Timeline v-Line */}
        <div className="absolute left-4 md:left-1/2 top-0 bottom-0 w-px bg-linear-to-br from-blue-500 to-blue-900 md:-translate-x-px"></div>
        {experiences.map((item, index) => {
          return (
            ...
            >
              {/* Timeline Node */}
              <div className="absolute left md:left-1/2 w-8 h-8 -translate-x-1/2 rounded-full bg-white border-2 border-blue-500 flex items-center justify-center z-10">
                {item.type === "work" ? (
                ...
                <div className="bg-white dark:bg-gray-900 shadow-md rounded-xl p-6 hover:scale-105 transition-all duration-300">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {item.technologies.map((tech) => {
                      return (
                        <span key={tech} className="text-xs px-2 py-1 rounded-md bg-blue-900 text-white">
                          {tech}
                        </span>
                      )
                    })}
