      ...
      <div className="mt-12 space-y-12">
        ...
        <section className="container mx-auto py-0">
          <SectionHeading
            title1="Check Your"
            title2="Eligibility"
            description="Review the requirements for our nursing programs and ensure you meet all criteria"
          />
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                  All applicants must meet the eligibility criteria listed
                  below. Additional requirements may apply for international
                  students. Please review the criteria carefully before
                  applying. For any queries, contact our admissions office.
                </p>
              </div>
            </div>
          </div>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    { label: "Subjects", value: "Biology, Chemistry, Physics" },
                    {
                      ...
                      value: "Any recognized board in Pakistan",
                    },
                  ].map((item, index) => (
                    <div
                      key={index}
                ...
                <div className="space-y-3">
                  {[
                    ...
                    { label: "Gender", value: "Female candidates only" },
                    {
                      ...
                      value: "Required (medical certificate)",
                    },
                    {
                      label: "Character Certificate",
                      value: "Required from last institution",
                    },
                  ].map((item, index) => (
                    <div
                      key={index}
            ...
            <div className="mt-8 p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-blue-200 dark:border-blue-800">
              ...
              <ul className="space-y-2 text-gray-600 dark:text-gray-400">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    Entrance test may be conducted for final selection
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-blue-600 mt-1">•</span>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  {[
                    {
                      label: "Qualification",
                      value: "Matriculation (10th Grade)",
                    },
