    ...
    <PageWrapper>
      ...
      <section className="max-w-7xl mx-auto">
        ...
        <SectionHeading
          title1="Our Academic "
          title2="Programs"
          description="Explore the nursing programs we offer"
        />
            ...
            return (
              ...
              >
                <div className="flex items-start justify-between mb-6">
                  <div className="inline-flex h-16 w-16 items-center justify-center rounded-full bg-linear-to-br from-primary/20 to-primary/5 text-primary ring-1 ring-primary/10">
      ...
      <section className="max-w-7xl mx-auto pt-0">
        ...
        <SectionHeading
          title1="Paramedical"
          title2=" Courses"
          description="Explore the paramedical courses we offer"
        />
      ...
      <section className="pt-0">
        <div className="flex flex-col items-center max-w-4xl mx-auto p-10 text-center bg-linear-to-r from-primary/10 to-primary/5 dark:from-primary/20 dark:to-primary/10 rounded-2xl">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-6 max-w-150 py-5">
            Our admission counselors are here to help you find the perfect
            nursing program for your career goals.
          </p>
          <Link
            href="/admissions"
